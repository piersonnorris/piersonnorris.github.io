  ...
  function seed() {
    ...
    return normalize([
         ...
         docs/ROADMAP.md §5. ---- */
      {
        ...
        milestones: ['Bottle/cork/ship click interaction', 'Home-page entrance', 'Island entrance', 'R10 direction picked', 'Polished /notes/ viewer', 'Fireflies fly jar to star (R23)', 'Fireflies land on their stars (R25)'],
